...
export const Up: React.FC<React.SVGProps<SVGSVGElement>> = props => (
	<svg fill='var(--logo)' height='200px' width='200px' {...props} version='1.1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' enableBackground='new 0 0 512 512'>
		...
		<g id='SVGRepo_iconCarrier'>
			<g>
				<g>
					...
					<path d='M480.6,460.2H51.8V31.4c0-11.3-9.1-20.4-20.4-20.4S11,20.1,11,31.4v449.2c0,11.3,9.1,20.4,20.4,20.4h449.2 c11.3,0,20.4-9.1,20.4-20.4C501,469.3,491.9,460.2,480.6,460.2z'></path>
				</g>
			</g>
		</g>
	</svg>
